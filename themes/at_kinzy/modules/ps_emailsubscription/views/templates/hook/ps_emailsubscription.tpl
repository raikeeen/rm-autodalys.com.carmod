  ...
  <div class="block_content">
    <form action="{$urls.pages.index}#footer" method="post">
        <div class="form-group">          
          ...
          <!-- </div> -->
          <button class="btn btn-outline" name="submitNewsletter" type="submit" value="{l s='PRENUMERUOKITE' d='Shop.Theme.Actions'}">
            <i class="fa fa-paper-plane"></i>
            <span>{l s='PRENUMERUOKITE' d='Shop.Theme.Global'}</span>
          </button>
