...
class HTMLTemplateOrderSlip extends HTMLTemplateOrderSlipCore
{
    ...
    public function replaceToken($html)
    {
        ...
        //echo '<pre>';var_dump($this->order_slip);
        //var_dump($this->order_slip->total_products_tax_incl);die;
        ...
        $orderDiscountedTotal += $this->order_slip->total_discount_tax_incl;
