    ...
    public function hookHeader()
    {
        ...
        if (Configuration::get('LEOFEATURE_ENABLE_PRODUCTWISHLIST')) {
            ...
            Media::addJsDef(array(
                ...
                'wishlist_add' => $this->l('Produktas sėkmingai pridėtas'),
                'wishlist_viewwishlist' => $this->l('Peržiūrėkite savo sarašą'),
                ...
                'buttonwishlist_title_remove' => $this->l('Ištrinti'),
                'wishlist_loggin_required' => $this->l('You must be logged in to manage your wishlist'),
                'isLogged' => $isLogged,
                'wishlist_cancel_txt' => $this->l('Cancel'),
                'wishlist_ok_txt' => $this->l('Tęsti'),
                'wishlist_send_txt' => $this->l('Send'),
                'wishlist_reset_txt' => $this->l('Reset'),
                'wishlist_send_wishlist_txt' => $this->l('Išsiųsti sarašą'),
                'wishlist_email_txt' => $this->l('El.paštas'),
                'wishlist_confirm_del_txt' => $this->l('Ištrinti pasirinktą elementą?'),
                'wishlist_del_default_txt' => $this->l('Negalima ištrinti numatytą sąrašą'),
