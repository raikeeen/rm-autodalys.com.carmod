	...
	<div class="notification-wrapper">
		<div class="notification notification-success">
			...
			*}
			...
			<span class="noti noti-update">{l s='Prekė buvo atnaujinta' mod='leofeature'}</span>
			<span class="noti noti-delete">{l s='Prekė pašalinta iš Jūsų krepšelio' mod='leofeature'}</span>
			<span class="noti noti-add"><strong class="noti-special"></strong> {l s='Prekė sėkmingai pridėta į Jūsų prekių krepšelį' mod='leofeature'}</span>
