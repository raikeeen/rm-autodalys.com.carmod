		...
		<div class="modal-content">
		  <div class="modal-header">
			...
			<h4 class="modal-title h2 text-xs-center">
				...
				{l s='RAŠYTI APŽVALGĄ' mod='leofeature'}
			</h4>
				...
				<div class="new_review_form_content col-xs-12 col-sm-6">					
					...
					<form class="form-new-review" action="#" method="post">
						<div class="form-group">
						  <label class="form-control-label" for="new_review_title">{l s='Pavadinimas' mod='leofeature'} <sup class="required">*</sup></label>
						  <input type="text" class="form-control" id="new_review_title" required="" name="new_review_title">					  
						</div>
						<div class="form-group">
						  <label class="form-control-label" for="new_review_content">{l s='Komentaras' mod='leofeature'} <sup class="required">*</sup></label>
						  <textarea type="text" class="form-control" id="new_review_content" required="" name="new_review_content"></textarea>				  
						</div>
						{if $allow_guests == true && !$is_logged}
							<div class="form-group">
							  <label class="form-control-label" for="new_review_customer_name">{l s='Vardas' mod='leofeature'} <sup class="required">*</sup></label>
							  <input type="text" class="form-control" id="new_review_customer_name" required="" name="new_review_customer_name">					  
							</div>
						{/if}
						<div class="form-group">
							<label class="form-control-label"><sup>*</sup> {l s='Privalomi laukai' mod='leofeature'}</label>
