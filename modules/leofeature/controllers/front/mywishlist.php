...
class LeoFeatureMyWishListModuleFrontController extends ModuleFrontController
{
        ...
        if ($context->customer->isLogged()) {
            ...
            if ($action == 'add-wishlist') {
                ...
                if (!count($errors)) {
                    ...
                    $result['message'] = $this->module->l('Naujas sarašas buvo sukurtas', 'mywishlist');
                }
            }
    ...
    public function getTemplateVarPage()
    {
        ...
        $page['meta']['title'] = Configuration::get('PS_SHOP_NAME').' - '.$this->l('Įsimintos prekės', 'Įsimintos-prekės');
    ...
    public function getBreadcrumbLinks()
    {
        ...
        $breadcrumb['links'][] = array(
            'title' => $this->l('Mano paskyra', 'mywishlist'),
            'url' => $this->context->link->getPageLink('my-account', true),
        );
        
        $breadcrumb['links'][] = array(
            'title' => $this->l('Įsimintos prekės', 'mywishlist'),
